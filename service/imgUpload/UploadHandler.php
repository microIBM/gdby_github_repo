...
class UploadHandler
{
    ...
    protected function get_distribute_path($uploaded_file, &$file) {
        $filemd5 = md5_file($uploaded_file);
        $ext = strtolower(substr($file->name, strrpos($file->name, ".")));
        $relative_path = substr($filemd5, 0, 2) . '/'
            . substr($filemd5, 2, 2) . '/'
            . $filemd5 . "-owm" . $ext;
        $file_path = $this->options['upload_dir'] . $relative_path;
        $file->url = $this->options['script_url'] . $filemd5. $ext;
        $file->saved_name = $this->options['bucket'] . '/' . $filemd5 . $ext;
        return $file_path;
    }
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        return $this->options['upload_dir'].$this->get_distribute_path($file_name).$file_name;
    }
    ...
    /**
     * 处理上传的临时文件
     * @param $uploaded_file php上传目录的临时文件
     * @param $name 上传的图片原始图片名
     * @return void
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file_path = $this->get_distribute_path($uploaded_file, $file);
            ...
            //比较文件的实际大小$file_size 和来自HTTP头的文件大小 $file->size
