        ...
        <div class="container-fluid">
            ...
            <nav class="col-xs-12 nav-list">
                ...
                <div class="current-data">
                    <div class="text-center">客户</div>
                    <div class="text-center font-30">
                        <span class="glyphicon glyphicon-menu-left pull-left J-date" name="left"></span><span class="J-cus-cnt-data"></span>&nbsp;<span class="font-16">个</span>
                ...
                <!-- 其他数据信息 -->
                <ul class="list-unstyled">
                    <li class="cus_details_block">
                        <div class="info-details clearfix text-center">
                            <div class="diy-inline pull-left"><div>下单客户</div><div><span class="font-30"><span class="J-order-cus-cnt-data"></span></span>&nbsp;个</div></div>
                            <div class="diy-inline vertical-line"></div>
                            <div class="diy-inline pull-right"><div>首单客户&nbsp;<span class="font-20 J-first-order-cus-cnt-data"></span>&nbsp;个</div><div>复购客户&nbsp;<span class="font-20 J-again-order-cus-cnt-data"></span>&nbsp;个</div></div>
                        </div>
                        <!--<div class="info-details clearfix text-center mt-15">
                            <div class="diy-inline pull-left cus-circle"><div>潜在<br>客户<div class="J-p-cus-cnt-data"></div></div></div>
                            <div class="diy-inline glyphicon glyphicon-arrow-right cus-arrow-1"></div>
                            <div class="diy-inline cus-circle"><div>注册<br>客户</div><div class="J-cus-cnt-data"></div></div>
                            <div class="diy-inline glyphicon glyphicon-arrow-right cus-arrow-2"></div>
                            <div class="diy-inline pull-right cus-circle"><div>下单<br>客户</div><div class="J-order-cus-cnt-data"></div></div>
                        </div>-->
                    </li>
                </ul>
            </nav>
