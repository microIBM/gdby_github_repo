...
class Customer extends MY_Controller {
    ...
    public function login() {
        ...
        $login_result = $this->userauth->login($_POST['mobile'], $_POST['password'], TRUE, C('site.dachu'));
    ...
    public function sub_account_list() {
        $tips = C('tips.code');
        $cur = $this->userauth->current(TRUE);
        empty($cur['id']) AND $this->_return_json(array('status' => $tips['op_success'], 'msg' => '还未登录!'));
