...
class Product extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->load->helper(array('img_zoom', 'product'));
   ...
   /**
    ...
    public function lists() {
        ...
        $this->_get_cate_info($post['upid'], $response);
    ...
    /**
     * @author: liaoxianwen@ymt360.com
     * @description 获取分类路径信息
     */
    private function _get_cate_info($upid, &$products) {
        //获取分类信息
        ...
        $products['cate_spec'] = $path_id_map_name ? $path_id_map_name : array();
        //返回一级分类和二级分类信息
        $products['top_two_cid'] = $this->cate_logic->get_top_two_cate($upid, TRUE);
    }
    //给商品信息列表添加关注信息
    ...
    public function get_product_detail() {
        ...
        $show_product_detail['net_weight_price'] = empty($net_weight) ? 0 : sprintf('%.2f', (($product_info['price']) / $net_weight)) . '元/斤';
        //售卖单位
