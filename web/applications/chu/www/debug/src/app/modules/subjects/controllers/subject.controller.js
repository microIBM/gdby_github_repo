...
angular
.module('dachuwang')
.controller('subjectController',['$window','$scope', '$stateParams','productService', 'categoryService', 'cartlist', 'Lightbox', 'rpc', function($window,$scope, $stateParams, productService, categoryService, cartlist, Lightbox, rpc) {
  // 商品列表
  // 分类获取
