...
angular
.module('dachuwang')
.controller('padController',['$rootScope' ,'$location', '$window','$scope', '$stateParams','$state','productService', 'categoryService', 'cartlist', 'Lightbox', 'userAuthService', 'daChuDialog',function( $rootScope,$location, $window,$scope, $stateParams, $state,productService, categoryService, cartlist, Lightbox, userAuthService, daChuDialog) {
  // 商品列表
  // 分类获取
