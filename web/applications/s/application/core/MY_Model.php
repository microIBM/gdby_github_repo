...
class MY_Model extends CI_Model {
    ...
    public function update_batch($data, $index) {
        $this->db->update_batch($this->_table, $data, $index);
        return $this->db->affected_rows();
    }
    ...
    public function get_one($fields, $query, $order_by='') {
        ...
        // 第二个参数传入FALSE，关闭字段保护，避免自动加上反引号“`”
        $this->db->from($this->_table)->select($fields, FALSE);
     ...
     */
    public function resort_data_by_date($data = array()){
        ...
        return !empty($sort_data) ? $sort_data : array();
    }
     ...
     * @author yuanxiaolin@dachuwang.com
     */
    public function create_sequence_day($stime = 0,$etime = 0){
