'use strict'
angular.module('hop').controller('AbnormalListOrderCtrl',['$location', 'dialog', 'req', '$scope','$cookieStore', function($location, dialog, req, $scope, $cookieStore){
  $scope.status = '-1';
  // 日期选择控件初始化
  $scope.dateOptions = {
    formatYear: 'yy',
  ...
  var getList = function() {
    ...
    req.getdata('abnormal_order/list_order', 'POST', function(data) {
      if(data.status == 0) {
        // 变更分页的总数
